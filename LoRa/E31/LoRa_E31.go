...
var (
  FACTORY_DEFAULTS                    = [...]byte{0x00, 0x00, 0x18, 0x50, 0x44}
  ...
  AIR_BAUD_1200 byte                  = 0x00
  AIR_BAUD_2400 byte                  = 0x01
  AIR_BAUD_4800 byte                  = 0x02
  AIR_BAUD_9600 byte                  = 0x03
  AIR_BAUD_19200 byte                 = 0x04
  AIR_BAUD_38400 byte                 = 0x05
  AIR_BAUD_50000 byte                 = 0x06
  AIR_BAUD_70000 byte                 = 0x07

  POWER_DBM_33 byte                   = 0x00
  POWER_DBM_30 byte                   = 0x01
  POWER_DBM_27 byte                   = 0x02
  POWER_DBM_24 byte                   = 0x03
